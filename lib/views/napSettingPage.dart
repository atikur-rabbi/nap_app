...
class _NapSettingsState extends State<NapSettings> {
  ...
  List<String> allAudioFiles = ["Meditation", "White Noise"];
                                      ...
                                      children: <Widget>[
                                        ...
                                        Column(
                                          children: <Widget>[
                                            ...
                                            Text(
                                              '''Adjust volume with volume key so 
  ...
  deleteDialog() {
    return showDialog(
        ...
        builder: (context) => AlertDialog(
              title: Text(
                  "You are about to reset your saved settings.\n\nAre you sure you wish to continue?"),
              actions: <Widget>[
                RaisedButton(
                    child: Text(
                      "Ok",
...
//Maps audio file assets in the /assets/ folder to a list.
  mapAssetsToList() async {
    ...
    //final soundPaths = ['assets/Meditation.mp3', ];
