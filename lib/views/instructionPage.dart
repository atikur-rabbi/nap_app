            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("2. Rest one or two fingers on the \"Text\" in\n the center of the screen", style: Theme.of(context).textTheme.title,),
                  Text("3. Wait for Vibration", style: Theme.of(context).textTheme.title,),
                  Text("4. Tap Screen and Leave Finger on the Screen.", style: Theme.of(context).textTheme.title,),
                  Text("5. Wait for Vibration", style: Theme.of(context).textTheme.title,),
                  Text("6. Repeat this sequence untill asleep", style: Theme.of(context).textTheme.title,),
                  Text("7. The alarm will wake you in 10 minutes.", style: Theme.of(context).textTheme.title,),
                  Padding(
                    padding: EdgeInsets.all(16),
                  ),
